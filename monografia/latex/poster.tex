...
\posterbox[adjusted title = Objetivo, smallmargins, equal height group = toprow, colback=white, before upper=\justifying]
    ...
    \noindent Este trabalho realiza uma experimentação aplicando o Modelo de Atores em um contexto distante do seu domínio natural: \textbf{aplicações centralizadas em Rust}. O objetivo é entender o esforço necessário para aplicar um padrão arquitetural fora do seu contexto natural e quais consequências isso traz para o projeto.
...
\posterbox[adjusted title = Original, smallmargins, equal height group = patchhub, colback=white, before upper=\justifying]
...
\posterbox[adjusted title = Reescrito, smallmargins, equal height group = patchhub, colback=white, before upper=\justifying]
