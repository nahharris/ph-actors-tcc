...
\begin{dedicatoria}
Dedicado a meus avós: Elizete e Jorge e a minha finada mãe: Sarah
\end{dedicatoria}
...
\pagestyle{mainmatter}
\input{conteudo/01-arquitetura-software}
\input{conteudo/02-modelo-atores}
\input{conteudo/03-estudo-caso}
