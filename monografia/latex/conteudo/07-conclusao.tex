...
\begin{itemize}
    ...
    \item \textbf{Operações com \emph{patches}:} A tela de conteúdo de um \emph{patch} no Patch-Hub original conta com \emph{features} como: marcar como revisado, aplicar série de \emph{patches} em um repositório local, entre outras.
