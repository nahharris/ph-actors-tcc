...
Esse trabalho realiza uma experimentação aplicando o Modelo de Atores em um contexto distante do seu contexto natural. O objetivo é entender se é possível extrair valor deste padrão arquitetural dadas as circunstâncias adversas e qual o nível de esforço necessário para isso. O principal resultado deste trabalho demonstra é:
