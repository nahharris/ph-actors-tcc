...
Desse modo, com os critérios de adequação utilizados, é possível concluir que o Modelo de Atores não é adequado para a criação de aplicações centralizadas em Rust e que aplicar ele neste contexto irá trazer consequências negativas para o projeto.
