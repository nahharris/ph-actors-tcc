...
O ator Terminal também expõe um \texttt{JoinHandle} que permite que outros atores detectem quando o terminal foi encerrado, permitindo encerramento gracioso da aplicação.
...
\begin{itemize}
    \item \texttt{KeyEvent}: Processa um evento de teclado recebido do Terminal
