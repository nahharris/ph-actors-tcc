...
gerados com a \textit{package} \texttt{pgfplots} (há um exemplo comentado neste
...
dados na forma de comandos para \texttt{tikz}\footnote{Você pode se interessar
...
excelente, não deixe de ler a documentação da \emph{package} \texttt{booktabs}.
...
da \emph{package} \texttt{siunitx} para alinhar as colunas numéricas pelo
...
documentação da \textit{package} \texttt{babel}. Para mudar temporariamente
